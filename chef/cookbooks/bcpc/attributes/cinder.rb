...
default['bcpc']['cinder']['deferred_deletion_purge_interval'] = nil
default['bcpc']['cinder']['enable_deferred_deletion'] = true
default['bcpc']['cinder']['image_volume_cache_enabled'] = true
default['bcpc']['cinder']['image_volume_cache_max_count'] = 100
