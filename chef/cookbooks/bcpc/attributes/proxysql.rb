...
default['bcpc']['proxysql']['eventslog_filename'] = 'eventlog.log'
default['bcpc']['proxysql']['eventslog_filesize'] = 104857600
default['bcpc']['proxysql']['eventslog_default_log'] = false
default['bcpc']['proxysql']['eventslog_format'] = 2
